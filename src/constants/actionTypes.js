...
export const SEARCH_SOURCES_NEWS_REQUEST = 'SEARCH_SOURCES_NEWS_REQUEST';
export const SEARCH_SOURCES_NEWS_SUCCESS = 'SEARCH_SOURCES_NEWS_SUCCESS';
export const SEARCH_SOURCES_NEWS_ERROR = 'SEARCH_SOURCES_NEWS_ERROR';